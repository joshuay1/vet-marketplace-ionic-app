...
@Component({
    templateUrl: "availModal.html"
  })
  
 export class AvailModal{
    vetId: string
    addAvail: FormGroup;
    hhs: any;
    hhe: any;
    ...
    constructor(public viewCtrl:ViewController,
      ...
      this.vetId = params.get("vetId");
      console.log("vet id in modal = "+ this.vetId);
    ...
    async add(){
      ...
      var param = "vetId="+this.vetId +"&date="+this.date+"&hhs="+hrs+"&hhe="+hre;
